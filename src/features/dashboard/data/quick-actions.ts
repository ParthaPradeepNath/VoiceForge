...
export const quickActions: QuickAction[] = [
  ...
  },
  {
    ...
    href: "/text-to-speech?=I am Kael, the last guardian of the Ember Blade. Step forward if you dare, but know this — I do not lose, and I do not forgive.",
  },
  {
    title: "Podcast Intro",
    description: "Create a professional podcast opening voice",
    gradient: "from-orange-400 to-orange-100",
    href: "/text-to-speech?=Welcome back to The Future Byte, where we break down the latest in AI, tech, and innovation. I'm your host, and today we dive into the world of voice cloning.",
  },
  {
    title: "Motivational Speech",
    description: "Generate powerful and inspiring speeches",
    gradient: "from-green-400 to-green-100",
    href: "/text-to-speech?=Every great journey begins with doubt. But what separates winners from the rest is the courage to take one more step, even when the path is unclear.",
  },
  {
    title: "YouTube Voiceover",
    description: "Create engaging narration for videos",
    gradient: "from-pink-400 to-pink-100",
    href: "/text-to-speech?=In today's video, we're exploring the top 5 AI tools that are changing the way creators produce content. Stick around till the end for a bonus tip!",
  },
  {
    ...
    href: "/text-to-speech?=System online. All neural pathways operational. Commander, I have analyzed the situation — the probability of mission success is currently at 87 percent.",
  },
];

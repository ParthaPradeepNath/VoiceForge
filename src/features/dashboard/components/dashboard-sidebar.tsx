          ...
          {items.map((item) => (
            <SidebarMenuItem key={item.title}>
              ...
              >
                ...
                onClick={item.onClick}
                tooltip={item.title}
                className="data-[active=true]:border-border flex h-9 items-center gap-2 border border-transparent px-3 py-2 text-[13px] font-medium tracking-tight data-[active=true]:shadow-[0px_1px_1px_0px_rgba(44,54,53,0.03),inset_0px_0px_0px_2px_white]"
              > */}
                {item.url ? (

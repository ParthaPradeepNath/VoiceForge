...
const envSchema = z.object({
  ...
  FILEBASE_ACCESS_KEY: z.string().min(1),
  FILEBASE_SECRET_KEY: z.string().min(1),
  FILEBASE_BUCKET_NAME: z.string().min(1),
});
